export class UploadPage {
  private readonly uploadFileFormButton =
    "button[data-bind=\"s19n:'FileUpload', click:sendFile\"]";
  ...
  static open(): UploadPage {
    ...
    cy.wait("@uploadedList")
      .its("response.statusCode")
      .should("equal", 200, "Check uploads list loaded");
  ...
  uploadFile() {
    ...
    cy.wait("@uploadFile")
      .its("response.statusCode")
      .should("equal", 200, "Check file upload");
    return this;
  }
}
